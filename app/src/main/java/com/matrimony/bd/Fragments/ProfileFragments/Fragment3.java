...
public class Fragment3 extends Fragment {
    ...
    private void saveData() {
        ...
        String GrewUp = grewUp.getText().toString();

        if (!PermanentAddress.isEmpty() && !CurrentAddress.isEmpty() && !GrewUp.isEmpty()) {
            ...
            document_reference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    if (!documentSnapshot.exists()) {
                        ...
                        userMap.put("permanentAddress", PermanentAddress);
                        userMap.put("currentAddress", CurrentAddress);
                        userMap.put("grewUp", GrewUp);
