...
public class Fragment7 extends Fragment {
    ...
    private void saveData() {
        ...
        String ParentsApproval = parentsApproval.getText().toString();
        String ReasonForMarriage = reasonForMarriage.getText().toString();

        if (!ParentsApproval.isEmpty() && !ReasonForMarriage.isEmpty()) {
            ...
            document_reference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    if (!documentSnapshot.exists()) {
                        ...
                        userMap.put("parentsApproval", ParentsApproval);
                        userMap.put("reasonForMarriage", ReasonForMarriage);
                        ...
                        document_reference.set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                parentsApproval.setEnabled(false);
                                reasonForMarriage.setEnabled(false);
