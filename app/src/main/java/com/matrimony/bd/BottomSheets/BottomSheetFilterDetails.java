...
public class BottomSheetFilterDetails extends BottomSheetDialogFragment {
    ...
    public BottomSheetFilterDetails() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FilterResultActivity activity = (FilterResultActivity) getActivity();
